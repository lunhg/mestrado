...
Começamos a investigação deste ciclo com um tipo específico de improvisação de códigos, o \emph{weavecoding} \ver{sec:weave}. Através de uma atividade  não-musical, buscamos ilustrar uma proposição e o código-fonte resultante resultante. Costuramos este fio condutor com a Música Eletrônica para Dançar \ver{sec:slub}, e fechamos com uma proposição coreográfica \ver{sec:coreografia}.
