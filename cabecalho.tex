\titulo{\emph{Live Coding}: um algoritmo gerador de uma sonoridade tonal no \emph{A Study in Keith} (2009)}
...
\orientador[Orientador: ]{Prof. Dr. Luiz Eduardo Castelões da Silva}
...
\preambulo{Dissertação apresentada ao Programa de Pós-Graduação em Artes, Cultura e Linguagens, para fins de obtenção do título de Mestre em Artes isuais, Música e Tecnologia, área de concentração Teorias e Processos Poéticos Interdisciplinares, da Universidade Federal de Juiz de Fora.}
%\EnableCrossrefs
%\CodelineIndex
%\RecordChanges
