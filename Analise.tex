...
A \autoref{fig:ask3} indica uma sequência de nêumas, em um jogo entre primeiro grau menor, e sétimo grau diminuto.
...
Uma pequena transcrição de um primeiro bloco como neumas, na mão direita:

\begin{figure}[!h]
  \centering
  \includegraphics[scale=1]{imagens/bipunctum.png}
  \includegraphics[scale=1]{imagens/podatus.png}
  \includegraphics[scale=1]{imagens/podatus.png}
\includegraphics[scale=1]{imagens/clivis.png}
  \caption{Notação neumática para a \autoref{fig:ask3}. Fonte: wikimedia.org.}
  \label{fig:neumaMD1}
\end{figure}
...
\begin{figure}[!h]
  \centering
  \includegraphics[scale=1]{imagens/porrectus.png}
  \includegraphics[scale=1]{imagens/podatus.png}
  \includegraphics[scale=1]{imagens/porrectus.png}
  \includegraphics[scale=1]{imagens/clivis.png}
  \caption{Notação neumática para um bipunctum, e uma \emph{clivis}, no primeiro evento sonoro. Fonte: wikimedia.org.}
