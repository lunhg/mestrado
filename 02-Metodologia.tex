...
A especificidade da linguagem significa a estratégia de manipulação de um material artístico. No caso de \citeonline[p.~97]{McLean2011}, as dimensões cognitivas são usadas para separar os materiais (o que é representado como material sonoro), da maneira como serão manipulados (o como é representado o material sonoro), em um fluxo temporal.
...
Formalmente, \citeonline[p.~8--9]{thornton_quantitative_2007} estabelece que espaços conceituais podem ser definidos pela gramática generativa \exref{ex:generativo},  

\begin{example}{Definição generativa de um conceito}

Podemos definir frases que conceitualizam o mesmo princípio, como ``aquela pessoa riu'', ``a mulher andou'' ou ``um homem correu'', a partir de uma regras generativas:

\begin{minted}[fontsize=\scriptsize]{coffeescript}
S -> NP V
NP -> Det N
...
Como redes hierárquicas, onde conceitos são verticalizados, e a relação entre os nós é representado por linhas \ver{fig:redes}:

\begin{figure}[!h]
  \centering
  \includegraphics[scale=0.5]{imagens/rede1.png}
  \caption{Verticalização de uma rede de conceitos. \textbf{Fonte}: \cite{thornton_quantitative_2007}}
  \label{fig:rede1}
\end{figure}

Esta rede pode ser subdividada em conceitos primitivos, categóricos, e conceitos compostos. Um conceito primitivo exemplar é \emph{live coding}. Como demonstramos ao longo do trabalho, um conceito primitivo pode gerar por exploração, conceitos categóricos, como \emph{algorave}, \emph{sensibilidade computacional}, \emph{agenciamento sonoro}. Por composição, \citeonline[p.~11]{thornton_quantitative_2007} coloca da seguinte forma:
...
\begin{figure}[!h]
  \centering
  \includegraphics[scale=0.5]{imagens/rede2.png}
  \caption{Conceitos categóricos e Conceitos compostos. \textbf{Fonte}: \cite{thornton_quantitative_2007}}
  \label{fig:rede1}
\end{figure}

É importante lembrar que esta hierarquia verticalizada aumenta em complexidade, conforme novas relações são encontradas no espaço conceitual, definido por \citeonline[p.~15-16]{thornton_quantitative_2007} como \emph{complexidade conceitual bruta}, \traducao{(\ldots) qualquer conceito $[$cujo$]$  o número de conceitos que deve ser desenvolvido a partir da fundação dada para garantir a sua construção}{The gross conceptual complexity of any concept is the number of concepts which must be developed from the given foundation to guarantee its construction}:

\begin{figure}[!h]
  \centering
  \includegraphics[scale=0.5]{imagens/rede3.png}
  \caption{Complexificação da Verticalização de uma rede de conceitos. \textbf{Fonte}: \cite{thornton_quantitative_2007}}
  \label{fig:rede2}
\end{figure}
...
\begin{figure}[!h]
  ...
  \caption{Extensões conceituais em uma malha de Complexificação. \textbf{Fonte}: \cite{thornton_quantitative_2007}}
  \label{fig:rede3}
\end{figure}

\todo{\tiny continuar até as zonas esponjosas para concluir com um pedaço das zonas, que é a intersecção dos grupos}
...
\begin{figure}[!h]
  \centering
  \includegraphics[scale=1]{imagens/rede4.png}
  \caption{Zonas esponjosas \textbf{Fonte}: \cite{thornton_quantitative_2007}}
  \label{fig:rede4}
\end{figure}

Para simplificação do nosso estudo \ver{cap:estudos_de_caso}, simplificaremos o processo como dois grupos conceituais em intersecção \exref{fig:contido}, com uma representação visual que indica a aderência de alguns, não todos, conceitos de dois diferentes espaços conceituais.
