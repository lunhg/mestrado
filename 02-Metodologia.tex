...
O contexto deste capítulo discute, como base em definições de criatividade \ver{sec:criatividade}, o \traducao{Quadro Conceitual de Sistemas Criativos}{Creative System Frameworks, \emph{ou CSF}} \ver{sec:csf}. Este quadro conceitual é uma formalização de processos criativos, de forma que possibilita discutir um modelo de improvisação de códigos \ver{sec:im}. Parte das formalizações serão separadas como ferramentas analíticas \ver{sec:diagrama} de um trecho de uma improvisação de códigos, no último capítulo. Por último definimos o escopo de análise \ver{sec:formaliza}.
...
É possível discutir quais valores a palavra \emph{criatividade} carrega. Uma simples busca em um dicionário\disponivelem{http://www.priberam.pt/dlpo/criatividade} apresenta  dois coinceitos gerais e um específico. O primeiro, e o mais geral de todos, ``Capacidade de criar, ou inventar''  apenas explicita um mecanismo \emph{gerativo}. Para \citeonline[p.~2]{thornton_quantitative_2007}, Boden discute que esta definição exibe um paradoxo, do ponto de vista de um computador:
...
A definição específica do dicionário, ``Capacidade que o falante de uma língua tem de criar novos enunciados sem que os tenha ouvido ou dito anteriormente.'', também possue este paradoxo. Aqui podemos identificar um mecanismo de avaliação (ou julgamento),' do que é impossível, e por consequência, criativo: \traducao{Para justificar a classificação de uma idéia criativa... alguém deve identificar os princípios generativos com respeito ao que é impossível}{To justify calling an idea creative... one must identify the generative principles with respect to which it is impossible.} \apud[p.~40;p.~3]{boden_creative_1990}{thornton_quantitative_2007}. Mas isso não quer dizer que, do ponto de vista mecanicista, a impossibilidade surge do nada. Para Boden, o impossível deriva de um processo de especificação: \traducao{Qualquer ato criativo é fundado na conceitualização ou realização de um ponto dentro de um espaço conceitual particular (\emph{idem}, \emph{ibidem})}{Any creative act is thus founded on conceptualisation or the realisation of a point within a particular ‘conceptual space’.}. Para Thornton e \citeonline[p.~450--451]{wiggins_framework_2006}, na primeira edição de seu livro, Boden não explica como são acessados os espaços conceituais. Por outro lado, oferece uma taxonomia de tipos de criativadade. 
